...
Now depending on whether the round was a SAFE or a priced round the shares will be issued immediately or promised in the future, but the effect is largely the same [with a few difference](https://www.notion.so/SAFE-vs-Priced-Round-3c5a0edb257449558cf968f5ded58812?pvs=21)s that we will discuss in the next chapter. 
...
[Suggested Reading: Introduction to SAFEs](https://www.notion.so/Introduction-to-SAFEs-f6e49d655a4b43a39b10c934addc1aa6?pvs=21)
